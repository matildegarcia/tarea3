...
// La funcion es O(n*m) peor caso, siendo n la cantidad de elementos en 'p' y m la
// cantidad de jugadas de la partida con mas jugadas entre todos los jugadores de 'p'.
